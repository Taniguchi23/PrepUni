                ...
                >
                    ...
                    <li class="nav-item">
                        <ul>
                            ...
                            <li class="menu nav-item">
                                <a href="{{route('estudiante.cursos.lista')}}" class="nav-link group">
                                    <div class="flex items-center">
                                        <svg
                                            class="shrink-0 group-hover:!text-primary"
                                            width="20"
                                        ...
                                        <span class="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Cursos</span>
                                    </div>
                                </a>
                            </li>
                        </ul>
